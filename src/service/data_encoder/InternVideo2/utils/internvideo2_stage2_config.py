...
model = dict(
    ...
    vision_encoder=dict(
        ...
        pretrained='/home/hoangtv/Desktop/Nhan_CDT/CERBERUS/research/Text_Video_Retrieval/src/service/data_encoder/InternVideo2/weights/InternVideo2-stage2_1b-224p-f4.pt',
        use_checkpoint=True,
        checkpoint_num=40,
